...
<div class="page-banner">
    <div class="page-banner__bg-image" style="background-image: url(<?php echo COFFEECOV; ?>);">
        <br><br><br><br>

    </div>
    <div style="height:500px" class="page-banner__content container t-center c-white">
        <h1 class="headline headline--medium"> Flavors from Around the World!</h1>
...
wp_reset_postdata();?>
            ...
            <p class="t-center no-margin"><a href="<?php echo site_url('/blog'); ?>" class="btn btn--purple">View All
                    Blog Posts</a></p>
        </div>
    </div>
</div>
