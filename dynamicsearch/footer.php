        ...
        <div class="group">
            ...
            <div class="site-footer__col-one">
                <h1 class="school-logo-text school-logo-text--alt-color">
                    <a href="<?php echo site_url() ?>"><strong>Jazz Music</strong> University</a></h1>
            ...
            <div class="site-footer__col-two-three-group">
                <div class="site-footer__col-two">
                    ...
                    <nav class="nav-list">
                        ...
                        <!--
            php
        // create dynamic menus in the dashboard - need to call the function from functions.php
        wp_nav_menu(array(
         ...
         -->
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo get_post_type_archive_link('ujprograms') ?>">Programs</a></li>

                            <li><a href="<?php echo site_url('/about-us') ?>">About JMU</a></li>
                            ...
                            <li><a href="<?php echo get_post_type_archive_link('professor') ?>">Professors</a></li>
